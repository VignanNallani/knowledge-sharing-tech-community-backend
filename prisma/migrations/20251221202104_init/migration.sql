...
CREATE TABLE "_UserCollaborations" (
    ...
    CONSTRAINT "_UserCollaborations_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "_UserCollaborations" ADD CONSTRAINT "_UserCollaborations_A_fkey" FOREIGN KEY ("A") REFERENCES "Collaboration"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UserCollaborations" ADD CONSTRAINT "_UserCollaborations_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
